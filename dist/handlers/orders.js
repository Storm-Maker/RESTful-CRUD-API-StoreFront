...
var create = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var order, newOrder, err_3, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var order, updateOrder, err_5, err_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
...
var addProduct = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var quantity, orderId, productId, addProductsInOrder, err_8;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                addProductsInOrder = _a.sent();
                res.json(addProductsInOrder).end();
                return [3 /*break*/, 4];
            case 3:
                err_8 = _a.sent();
                res.status(400).json(err_8).end();
                return [3 /*break*/, 4];

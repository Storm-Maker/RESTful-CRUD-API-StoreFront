...
var OrderStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Cannot get the order with ID:".concat(id, ". Error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Cannot create new order. Error: ".concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [o.id, o.status])];
                    case 2:
                        result = _a.sent();
                        order = result.rows[0];
                        conn.release();
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Cannot edit order with ID:".concat(o.id, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    OrderStore.prototype.addProduct = function (quantity, orderId, productId) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sqlOrder, result, order, err_6, conn, sql, result, order, err_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 2:
                        ...
                        if (order.status !== "active") {
                            throw new Error("Couldn't add product ".concat(productId, " to order ").concat(orderId, " because order status is ").concat(order.status));
                        }
                        ;
                        conn.release();
                        return [3 /*break*/, 4];
                    case 3:
                        err_6 = _a.sent();
                        throw new Error("Couldn't add product ".concat(productId, " to order ").concat(orderId, ". Error:").concat(err_6));
                    case 4:
                        _a.trys.push([4, 7, , 8]);
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 5:
                    ...
                    case 7:
                        err_7 = _a.sent();
                        throw new Error("Cannot add product ".concat(productId, " to order ").concat(orderId, ". Error: ").concat(err_7));
